...
LEXERS = {
    ...
    'BashLexer': ('pygments.lexers.shell', 'Bash', ('bash', 'sh', 'zsh', 'ksh', 'shell'), ('*.sh', '*.ksh', '*.bash', '*.ebuild', '*.eclass', '*.exheres-0', '*.exlib', '.bashrc', 'bashrc', '.bash_*', 'bash_*', 'PKGBUILD'), ('application/x-sh', 'application/x-shellscript')),
